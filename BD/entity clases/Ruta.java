...
public class Ruta implements Serializable {
    ...
    private Collection<Parada> paradaCollection;
    ...
    @XmlTransient
    public Collection<Parada> getParadaCollection() {
        return paradaCollection;
    }

    public void setParadaCollection(Collection<Parada> paradaCollection) {
    ...
    public String toString() {
        return "entity.Ruta[ rutaPK=" + rutaPK + " ]";
    }
